...
public final class FooterBinding implements ViewBinding {
  ...
  private FooterBinding(@NonNull LinearLayout rootView, @NonNull Button buttonRetry,
  ...
  public static FooterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FooterBinding((LinearLayout) rootView, buttonRetry, progressBar, textViewError);
    }
